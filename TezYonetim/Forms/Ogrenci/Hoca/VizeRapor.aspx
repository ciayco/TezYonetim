<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Hoca/MasterPageHoca.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="VizeRapor.aspx.cs" Inherits="Forms_Hoca_RaporTarih" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Vize Rapor Tarihi Ekle</title>
</asp:Content>
            ...
            <div id="signupbox" style="margin-top: 50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="panel-title">Vize Rapor Tarihi Ekle</div>
                    </div>
