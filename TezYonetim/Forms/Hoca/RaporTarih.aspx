<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Hoca/MasterPageHoca.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RaporTarih.aspx.cs" Inherits="Forms_Hoca_RaporTarih" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Rapor Tarihi Ekle</title>
</asp:Content>
                ...
                <div class="panel panel-info">
                    ...
                    <form id="signupform" class="form-horizontal" role="form">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-md-3 control-label">Rapor Sayısı: </label>
                                <div class="col-md-9">
                                    <asp:TextBox ID="RaporAdet" type="number" value="3" class="form-control" name="RaporAdet" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-9">
