<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Hoca/MasterPageHoca.master" AutoEventWireup="true" CodeFile="TezAra.aspx.cs" Inherits="Forms_Hoca_TezAra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group">
                                <label for="name" class="col-md-3 control-label">Keywordler: </label>
                                <div class="col-md-9">
                                    <select name="Keywords" id="KeywordBox" class="js-example-basic-multiple form-control" multiple="multiple" style="width: 350px; height: 25px"></select>
                                </div>
                                ...
                                $(".js-example-basic-multiple").select2(
                                    {
                                        ...
                                        "language": {
                                            "noResults": function () {
                                                return "Keyword girdikten sonra Enter'a basabilir ya da virgül (,) koyabilirsiniz.";
                                            }
                                        },
                                    });
                            </script>
